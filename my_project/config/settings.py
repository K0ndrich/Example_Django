...
# STATIC_ROOT хранит путь по которому наш веб-сервер NGINX будет брать и возвращаться клиненту на сайт статические файлы
# NGINX будет брать статические файлы вместе приложения django, минимизируючи нагрузку на ето приложение django
...
# -----   ДОПОЛНИТЕЛЬНЫЕ НАСТРОЙКИ ДЛЯ ПОДКЛЮЧЕНЫХ БИБЛИОТЕК К НАШЕМУ ПРОЕКТУ   ------------------------------------------------------------------------------------------------------------------------
# ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
