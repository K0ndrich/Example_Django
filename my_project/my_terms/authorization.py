...
# Session-Based authentificatiion - аутентификация на основе сессий и cookies (встроенный в django)
...
# Session-Based Authentificatiion (базовая аутентификация пользователя) - браузер отправляет cookies пользователя, он же session_id на сервера
