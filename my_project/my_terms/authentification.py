# Авторизация и Аунтентификация Пользователей на Сайте
...
#  - обычная аутентифкация токанеми библиотеки Djoser (наш вариант)
...
# Payload   - json-строка, которая содержит информацию о пользователе (username , password, email), которому генерируем JWT-токен (также имеет название полезные данные)
